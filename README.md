...
Program ini menggunakan thread agar proses menerima pesan dari server dan mengirim pesan dari pengguna bisa berjalan bersamaan. Di client juga tersedia beberapa command, seperti /list untuk melihat daftar file di server, /upload <filename> untuk mengirim file ke server, dan /download <filename> untuk mengambil file dari server.”
